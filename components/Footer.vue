    ...
    <div class="my_container py-20 md:py-24 lg:py-30 xl:py-40">
      <div class="flex flex-wrap gap-40 gap-y-24 mb-40 lg:mb-60">
        ...
        <a
          ...
          :key="item.id"
          class="w-full md:w-auto text-center p-16 px-40 text-white text-14 lg:text-20 font-medium font-interfaces_500 border border-grey_8"
          >{{ item.title }}</a
        >
        <nuxt-link
          ...
          :key="item.id"
          class="w-full md:w-auto p-16 px-40 border border-grey_8"
          ><p
            class="text-white text-14 lg:text-20 text-center font-medium font-interfaces_500"
          >
            {{ item.title }}
          </p></nuxt-link
        >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-40 mb-16">
        <div class="py-24 border-y border-grey_border">
          <div
            class="flex items-center justify-center md:justify-start gap-24 mb-24"
          >
            <img class="w-40 h-40" src="../assets/icons/Location.png" alt="" />
            <p class="text-white text-24 font-inter font-medium leading-140">
              {{ $t("main_text_15") }}
            </p>
          </div>
          <p
            class="text-14 lg:text-16 2xl:text-18 font-inter text-grey_40 text-center md:text-start"
          >
            {{ data.adres }}
          </p>
        </div>
        <div class="py-24 border-y border-grey_border">
          ...
          <div class="flex flex-wrap items-center gap-24">
            <a
              :href="`tel:${nbm_phone}`"
              class="text-14 lg:text-16 2xl:text-18 font-inter text-grey_40"
              >{{ nbm_phone }}</a
            >
            <a
              :href="`tel:${nbm_faks}`"
        ...
        <div class="py-24 border-y border-grey_border">
          ...
          <div
            class="flex items-center justify-center md:justify-start gap-30 xl:gap-40"
          >
      ...
      >
        ...
        <div class="flex items-center gap-3">
          <p
            class="text-14 lg:text-16 2xl:text-18 font-interfaces font-medium text-grey_40"
          >
            {{ $t("designer") }}
          </p>
          <a
            target="_blank"
            href="https://ndc.uz/"
            class="text-14 lg:text-16 2xl:text-18 font-interfaces font-medium text-white"
          >
            NDC
          </a>
        </div>
