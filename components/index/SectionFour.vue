<template>
  <section class="bg-white py-40 lg:py-60 xl:py-80 2xl:py-100">
    <div class="my_container">
      <div
        class="box bg-black px-20 md:px-40 py-50 md:py-60 lg:py-72 xl:py-84 mb-60 lg:mb-100"
      >
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-50 max-w-1366 mx-auto">
          <div>
            <p
              class="text-white font-interfaces_600 font-semibold text-24 lg:text-28 xl:text-32 2xl:text-40 mb-20 lg:mb-32 xl:mb-44"
            >
              {{ $t("main_text_14") }}
            </p>
            ...
            <div class="mb-32">
              ...
              <p class="text-18 font-interfaces font-semibold">
                {{ data.adres }}
              </p>
            </div>
            ...
            <div class="flex flex-wrap items-start gap-32 gap-x-56">
              <div class="flex md:flex-col flex-wrap gap-32">
                <div>
                  ...
                  <p class="text-18 font-halvar font-bold uppercase">
                    {{ nbm_phone }}
                  </p>
                </div>
          ...
          <div>
            ...
            <form @submit.prevent="onSubmit()">
              ...
              <div class="flex flex-col xl:flex-row gap-16">
                ...
                >
                  <p
                    class="text-14 font-interfaces font-bold uppercase text-white"
                  >
                    {{ $t("main_text_23") }}
                  </p>
                  <img
...
<style scoped>
.box {
  background: #18171b url("../../assets/images/bg_img_1.png") no-repeat left
    center;
...
@media (max-width: 1024px) {
  .box {
    background: #18171b url("../../assets/images/bg_img_1.png") no-repeat top
      center;
